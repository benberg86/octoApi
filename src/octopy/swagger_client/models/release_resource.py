...
class ReleaseResource(object):
    ...
    swagger_types = {
        ...
        'build_information': 'list[ReleasePackageVersionBuildInformationResource]',
        'assembled': 'datetime',
        'project_id': 'str',
    ...
    def __init__(self, id=None, version=None, channel_id=None, release_notes=None, project_deployment_process_snapshot_id=None, ignore_channel_rules=None, build_information=None, assembled=None, project_id=None, library_variable_set_snapshot_ids=None, selected_packages=None, project_variable_set_snapshot_id=None, space_id=None, last_modified_on=None, last_modified_by=None, links=None):  # noqa: E501
    ...
    def build_information(self):
        """Gets the build_information of this ReleaseResource.  # noqa: E501


        :return: The build_information of this ReleaseResource.  # noqa: E501
        :rtype: list[ReleasePackageVersionBuildInformationResource]
        """
        return self._build_information

    @build_information.setter
    def build_information(self, build_information):
        """Sets the build_information of this ReleaseResource.


        :param build_information: The build_information of this ReleaseResource.  # noqa: E501
        :type: list[ReleasePackageVersionBuildInformationResource]
        """
