...
class ProjectResource(object):
    ...
    attribute_map = {
        ...
        'deployment_changes_template': 'DeploymentChangesTemplate',
        'space_id': 'SpaceId',
    ...
    def __init__(self, id=None, variable_set_id=None, deployment_process_id=None, cloned_from_project_id=None, discrete_channel_release=None, included_library_variable_set_ids=None, default_to_skip_if_already_installed=None, tenanted_deployment_mode=None, default_guided_failure_mode=None, versioning_strategy=None, release_creation_strategy=None, templates=None, auto_deploy_release_overrides=None, release_notes_template=None, deployment_changes_template=None, space_id=None, extension_settings=None, name=None, slug=None, description=None, is_disabled=None, project_group_id=None, lifecycle_id=None, auto_create_release=None, project_connectivity_policy=None, last_modified_on=None, last_modified_by=None, links=None):  # noqa: E501
        ...
        self._deployment_changes_template = None
        self._space_id = None
        ...
        if deployment_changes_template is not None:
            self.deployment_changes_template = deployment_changes_template
    ...
    @property
    def deployment_changes_template(self):
        """Gets the deployment_changes_template of this ProjectResource.  # noqa: E501


        :return: The deployment_changes_template of this ProjectResource.  # noqa: E501
        :rtype: str
        """
        return self._deployment_changes_template

    @deployment_changes_template.setter
    def deployment_changes_template(self, deployment_changes_template):
        """Sets the deployment_changes_template of this ProjectResource.


        :param deployment_changes_template: The deployment_changes_template of this ProjectResource.  # noqa: E501
        :type: str
        """

        self._deployment_changes_template = deployment_changes_template
