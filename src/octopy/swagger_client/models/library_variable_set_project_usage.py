...
class LibraryVariableSetProjectUsage(object):
    ...
    swagger_types = {
        ...
        'project_name': 'str',
        'project_id': 'str',
        'runbook_snapshots': 'list[LibraryVariableSetRunbookSnapshotUsageEntry]',
    ...
    def __init__(self, project_slug=None, project_name=None, project_id=None, runbook_snapshots=None, releases=None, is_currently_being_used_in_project=None):  # noqa: E501
    ...
    def runbook_snapshots(self):
        """Gets the runbook_snapshots of this LibraryVariableSetProjectUsage.  # noqa: E501


        :return: The runbook_snapshots of this LibraryVariableSetProjectUsage.  # noqa: E501
        :rtype: list[LibraryVariableSetRunbookSnapshotUsageEntry]
        """
        return self._runbook_snapshots

    @runbook_snapshots.setter
    def runbook_snapshots(self, runbook_snapshots):
        """Sets the runbook_snapshots of this LibraryVariableSetProjectUsage.


        :param runbook_snapshots: The runbook_snapshots of this LibraryVariableSetProjectUsage.  # noqa: E501
        :type: list[LibraryVariableSetRunbookSnapshotUsageEntry]
        """
